...
export const PowerBtn = ({ fill = 'currentColor', width = 30, height = 30, ...props }) => {
  return (
    <svg
      ...
      {...props} // Spread additional props like fill, className, etc.
    >
      <path
        fill={fill} // Use the fill prop, defaults to 'currentColor'
